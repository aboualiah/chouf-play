...
export default function Index() {
  ...
  const renderContent = () => {
    ...
    if (activeTab === "live") {
      return (
        <div className="flex w-full h-full overflow-hidden" style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at 20% 50%, rgba(255,109,0,0.03) 0%, #0D0D1A 60%)" }}>
          {/* ═══ Column 1: Categories ═══ */}
          ...
          <div className="flex-1 min-w-0 flex flex-col" style={{ background: "radial-gradient(ellipse at 50% 30%, rgba(255,109,0,0.04) 0%, #12122A 70%)", overflow: "hidden" }}>
            {previewChannel ? (() => {
